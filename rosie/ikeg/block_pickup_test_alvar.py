...
solve_move_trac(mylimb, make_pose_stamped(Point(x=0.49, y=-0.0, z=0.0), frame_id='base'))
...
rospy.sleep(2)
getavgpos()
solve_move_trac(mylimb, make_pose_stamped(Point(x=avgpos.x, y=avgpos.y, z=avgpos.z+0.10), frame_id='head'))
rospy.sleep(2)
getavgpos()
solve_move_trac(mylimb, make_pose_stamped(Point(x=avgpos.x, y=avgpos.y, z=avgpos.z+0.07), frame_id='head'))
rospy.sleep(2)
getavgpos()
solve_move_trac(mylimb, make_pose_stamped(Point(x=avgpos.x, y=avgpos.y, z=avgpos.z+0.04), frame_id='head'))
